...
* Lucas
- [ ] Raycasting
- [ ] Collision boxes / area 2D (AABB / circle / polygon)
- [ ] Rigid bodies (rapier)
- [ ] Custom polygons from shapes
- [ ] physics system needs retained state. let the user retain it wherever they want. just put it all in a struct.
