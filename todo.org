...
** Rendering
 ...
 - [ ] Occlusion culling: Don't even add shapes to draw queue if they're completely outside view
...
** Graphics Features
 ...
 - [ ] Textures: Load and render textured quads/sprites
...
** Shapes & Primitives
 ...
 - [ ] Polylines: Connected line segments with joins
...
** Debugging & Profiling
 ...
 - [ ] Performance overlay: FPS, draw calls, vertex count, etc.
